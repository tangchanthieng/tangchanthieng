...
1. Programming & Analysis: **Python** (Python (Pandas, NumPy, Scikit-learn, TensorFlow, Streamlit, Seaborn, Matplotlib), **R** (EDA, Statistics, Spatial Analysis, Regression, PCA, Time Series), **SAS** (Enterprise Miner, Viya), **Stata**.
